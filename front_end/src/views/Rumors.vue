  ...
  <div class="rumor_container">
    ...
    <div class="rumor_content">
      ...
      <div class="rumor_introduction">
        <p>
          这次新型肺炎牵动了无数人的心，伴随着疫情的发展，各种谣言也在网上流传。
      ...
      <!--      谣言版块-->
      <div class="card bg-light mb-3" v-for="item in result" :key="item.id">
        <div class="card-header">
          {{ item.title }}<span class="icon1">谣言</span>
        </div>
        <div class="card-body">
          <h5 class="title">
          ...
          <h5 class="title">
            真相：<span class="icon4">{{ item.truth }}</span>
          </h5>
          <h5 class="title">查据要点：</h5>
          <p v-html="item.content"></p>
          <h5 class="title">
            查证来源：<span class="icon4">{{ item.sounce }}</span>
          </h5>
        </div>
      </div>
    </div>
